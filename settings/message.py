from bot.settings.config import KEYBOARD, VERSION, AUTHOR

trading_store = """

<b style="text-align: center">Добро пожаловать в приложение
            GroceryStore !!!</b>
...
<i>Общая стоимость заказа составляет:</i> <b>{} сум</b>
